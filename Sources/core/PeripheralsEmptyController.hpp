/**
 * @file      PeripheralsEmptyController.hpp
 *
 * @author    Filip Stupka \n
 *            xstupk05@fit.vutbr.cz
 *
 * @brief     Header for a disconnected controller peripheral
 *
 * @version   0.1
 *
...
#ifndef PERIPHERALSEMPTYCONTROLLER_HPP
#define PERIPHERALSEMPTYCONTROLLER_HPP
...
namespace PSX
{
     ...
     */
    class PeripheralsEmptyController final : public PeripheralsController
    {
    public:

        PeripheralsEmptyController(const std::shared_ptr<PeripheralsInput>& input);
...
#endif // PERIPHERALSEMPTYCONTROLLER_HPP