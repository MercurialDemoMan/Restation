/**
 * @file      SPUConstants.hpp
 *
 * @author    Filip Stupka \n
 *            xstupk05@fit.vutbr.cz
 *
 * @brief     Header for the PSX Sound processing unit constants
 *
 * @version   0.1
 *
 * @date      13. 03. 2024, 16:51 (created)
 *
 * @section License
...
#ifndef SPUCONSTANTS_HPP
#define SPUCONSTANTS_HPP
...
namespace PSX
{
    constexpr const u32 SRAMSize = 512 * KiB;
};

#endif // SPUCONSTANTS_HPP