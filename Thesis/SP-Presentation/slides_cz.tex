...
\begin{frame}\frametitle{Architektura}
  \makebox[\linewidth]{\includegraphics[width=0.7\paperwidth]{img/psx-layout.png}}
\end{frame}
...
\begin{frame}
  ...
  \column{0.6\textwidth}
    \centering
    \includegraphics[width=0.7\textwidth]{img/bios-boot-original.png}
    
    \bigskip
    \includegraphics[width=0.7\textwidth]{img/bios-boot-mine.png}
...
\begin{frame}
  ...
  \makebox[\textwidth]{
    \begin{tikzpicture}
      \node (screenshot) 
         {\includegraphics[width=0.5\paperwidth]{img/psx-console.jpg}};
      \node (schema) at (screenshot.south east) [xshift=5em] [yshift=2.5ex]
         {\includegraphics[width=0.35\paperwidth]{img/psx-layout.png}};
      \node (goal) at (screenshot.north east) [xshift=4em] [yshift=2ex]
         {\includegraphics[width=0.4\paperwidth]{img/bios-boot-mine.png}};
    \end{tikzpicture}
  }
\end{frame}
